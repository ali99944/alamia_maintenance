      ...
      <section className="bg-gradient-to-b from-blue-50 via-gray-50 to-gray-100 pt-24 pb-16 md:pt-32 md:pb-20 text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl md:text-5xl lg:text-5xl font-bold text-gray-800 mb-4">
            تواصل مع مركز الصيانة
          </h1>
          <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            هل لديك استفسار أو ترغب في حجز موعد صيانة؟ فريق خدمة الصيانة في خدمتك.
          </p>
          {brandData.hotline && (
            <a href={`tel:${brandData.hotline}`}>
              <button 
                className="px-8 py-2 text-white text-base font-semibold cursor-pointer shadow-md hover:opacity-90 transition duration-300"
